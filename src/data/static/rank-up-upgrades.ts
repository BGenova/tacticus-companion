...
/** Ordered rank tier names, index = numeric CharacterProgress.rank (0-based). */
export const RANK_TIER_NAMES = [
  ...
  'Adamantine I', 'Adamantine II',
] as const;

/** characterId -> rank tier name -> upgrade material ids required to reach that tier. */
export const RANK_UP_UPGRADES: Record<string, Record<string, string[]>> = {
  "ultraTigurius": {
    "Stone I": [
      "upgHpC003",
      "upgHpU001",
